...
struct Place: Identifiable, Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        case id, name, url, category, notes, latitude, longitude
    }

    init(id: UUID, name: String, url: URL?, category: String, notes: String, coordinate: CLLocationCoordinate2D?) {
        self.id = id
        self.name = name
        self.url = url
...
struct Outfit: Identifiable, Codable { let id: UUID; var imageFileName: String; var caption: String }
